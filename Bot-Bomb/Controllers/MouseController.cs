...
namespace Bot_Bomb.Controllers
{
    public class MouseController
    {
        ...
        public static void MoveCursor(Rectangle location)
        {
            ...
            //Cursor.Clip = new Rectangle(location.Location, location.Size);
            DoMouseClick();
        }
        ...
        public static Boolean FindLocation(Bitmap FirstScreen, Bitmap SecondScreen)
        {
            Boolean resultado = true;
            CaptureController.screen();
            Bitmap ThreedScreen = new Bitmap(@"C:\Users\lipex\Documents\Repository\Bot-Bomb\Bot-Bomb\ScreenSave\ScreenShot.jpg", true);
            Rectangle location2 = new Rectangle();
            Rectangle location1 = CaptureController.searchBitmap(SecondScreen, FirstScreen, 0.5);
            int x = 0, y = 0;
            ...
            ThreedScreen.Save(@"C:\Users\lipex\Documents\Repository\Bot-Bomb\Bot-Bomb\ScreenSave\Finish.jpg", ImageFormat.Jpeg);
            ...
            System.IO.File.Delete(@"C:\Users\lipex\Documents\Repository\Bot-Bomb\Bot-Bomb\ScreenSave\ScreenShot.jpg");
            System.IO.File.Delete(@"C:\Users\lipex\Documents\Repository\Bot-Bomb\Bot-Bomb\ScreenSave\Finish.jpg");
